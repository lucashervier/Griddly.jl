...
Here is a script example without rendering on how you can play these game with a raw interface:
...
Now the same game but with a MultipleScreen rendering:
...
```
You should have a rendering screen that looks like this:
